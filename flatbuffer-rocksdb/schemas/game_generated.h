...
template<> struct EquipmentTraits<game::Weapon> {
...
struct Monster FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  game::Color color() const {
    return static_cast<game::Color>(GetField<int8_t>(VT_COLOR, 2));
  }
  const flatbuffers::Vector<flatbuffers::Offset<game::Weapon>> *weapons() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<game::Weapon>> *>(VT_WEAPONS);
  }
  game::Equipment equipped_type() const {
    return static_cast<game::Equipment>(GetField<uint8_t>(VT_EQUIPPED_TYPE, 0));
  }
  const void *equipped() const {
    return GetPointer<const void *>(VT_EQUIPPED);
  }
  template<typename T> const T *equipped_as() const;
  const game::Weapon *equipped_as_Weapon() const {
    return equipped_type() == game::Equipment_Weapon ? static_cast<const game::Weapon *>(equipped()) : nullptr;
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<game::Vec3>(verifier, VT_POS) &&
...
template<> inline const game::Weapon *Monster::equipped_as<game::Weapon>() const {
...
struct MonsterBuilder {
  ...
  void add_color(game::Color color) {
    fbb_.AddElement<int8_t>(Monster::VT_COLOR, static_cast<int8_t>(color), 2);
  }
  void add_weapons(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<game::Weapon>>> weapons) {
    fbb_.AddOffset(Monster::VT_WEAPONS, weapons);
  }
  void add_equipped_type(game::Equipment equipped_type) {
...
inline flatbuffers::Offset<Monster> CreateMonster(
    ...
    const game::Vec3 *pos = 0,
    int16_t mana = 150,
    int16_t hp = 100,
    flatbuffers::Offset<flatbuffers::String> name = 0,
    flatbuffers::Offset<flatbuffers::Vector<uint8_t>> inventory = 0,
    game::Color color = game::Color_Blue,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<game::Weapon>>> weapons = 0,
    game::Equipment equipped_type = game::Equipment_NONE,
...
inline flatbuffers::Offset<Monster> CreateMonsterDirect(
    ...
    game::Color color = game::Color_Blue,
    const std::vector<flatbuffers::Offset<game::Weapon>> *weapons = nullptr,
    game::Equipment equipped_type = game::Equipment_NONE,
    flatbuffers::Offset<void> equipped = 0,
    const std::vector<game::Vec3> *path = nullptr) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  auto inventory__ = inventory ? _fbb.CreateVector<uint8_t>(*inventory) : 0;
  auto weapons__ = weapons ? _fbb.CreateVector<flatbuffers::Offset<game::Weapon>>(*weapons) : 0;
  auto path__ = path ? _fbb.CreateVectorOfStructs<game::Vec3>(*path) : 0;
  return game::CreateMonster(
      _fbb,
      pos,
      mana,
      hp,
...
inline bool VerifyEquipment(flatbuffers::Verifier &verifier, const void *obj, Equipment type) {
  switch (type) {
    ...
    case Equipment_Weapon: {
      auto ptr = reinterpret_cast<const game::Weapon *>(obj);
...
inline const game::Monster *GetMonster(const void *buf) {
  return flatbuffers::GetRoot<game::Monster>(buf);
}

inline const game::Monster *GetSizePrefixedMonster(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<game::Monster>(buf);
}

inline bool VerifyMonsterBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<game::Monster>(nullptr);
}

inline bool VerifySizePrefixedMonsterBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<game::Monster>(nullptr);
}

inline void FinishMonsterBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<game::Monster> root) {
  fbb.Finish(root);
}
